...
<head>
    ...
    <title>EPA Solution ADMIN DASHBOARD</title>
   ...
   <link rel="stylesheet" type="text/css" href="{{ URL::to('css/bootstrap.min.css') }}">
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" type="text/css" href="{{ URL::to('css/sb-admin.css') }}">

    <!-- Morris Charts CSS -->
    <link rel="stylesheet" type="text/css" href="{{ URL::to('css/plugins/morris.css') }}">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">EPA Solution ADMIN DASHBOARD</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                   ...
                   <li>
                    ...
                    <li>
                        <a href="/"><i class="fa fa-fw fa-home"></i> Store Front Page</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div id="page-wrapper">
            ...
            <!-- dito ko tinanggal yung container fluid -->
